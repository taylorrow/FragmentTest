...
class DataAdapterFragmentOne extends RecyclerView.Adapter<DataAdapterFragmentOne.ViewHolder> {

    private List<DataModel> models;
    private LayoutInflater inflater;
    Context context;

    DataAdapterFragmentOne(Context context, List<DataModel> dataModels) {
    ...
    @Override
    public DataAdapterFragmentOne.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(DataAdapterFragmentOne.ViewHolder holder, int position) {
