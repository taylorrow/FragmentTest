...
public class FragmentOne extends Fragment {
    ...
    private void getAllWidgets(View view) {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerFragmentOne);
    ...
    private void setAdapter(List<DataModel> list) {
        recyclerView.setAdapter(new DataAdapterFragmentOne(MainActivity.instance, list));
    }

    private void getData() {

        App.getApi().getData("cat").enqueue(new Callback<Data>() {
            @Override
